...
def setup_logger(
    ...
    color: bool = True, name: str = "ICDM", abbrev_name: Optional[str] = None
):
    """Initialize the ICDM logger and set its verbosity level to "DEBUG".
    ...
    name : str, optional
        the root module name of this logger, by default "ICDM"
...
def get_logger(name: str = "ICDM"):
    """Get a logger for a given name.

    Parameters
    ----------
    name : str, optional
        name of the logger, by default "ICDM"
